...
It should be as a single .zip archive, with the filename <Team number\>\_<Team member 1 Name\>\_<Team member 2 Name\>\_1.zip. One submission per team is sufficient. It will show as not submitted for the other person, but that is ok. If you are doing solo, do not include \_<Team member 2 Name\> in the filename.
